...
# cd '/home/srghma/.local/share/Anki2/user2/collection.media/anki-addon-glossary/' && zip -r --temp-path /tmp/ /home/srghma/Downloads/anki-addon-glossary.zip .
cd '/home/srghma/.local/share/Anki2/user2/collection.media/' && zip -r --temp-path /tmp/ /home/srghma/Downloads/collection.media.zip .
